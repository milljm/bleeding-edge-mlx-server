...
export const FLAG_DEFS: FlagDef[] = [
  ...
  },
  {
    ...
    flag: "--adapter-path",
    label: "Adapter path",
    help: "Path to a directory with adapter_config.json and LoRA weights. Leave empty if unused.",
    type: "text",
    engines: ["lm", "vlm"],
    advanced: true,
    default: "",
  },
  {
    ...
    flag: "--draft-model",
    label: "Draft model",
    help: "Smaller same-family model for speculative decoding. Reloads into this engine — not a second Serve.",
    type: "text",
    engines: ["lm", "vlm"],
    advanced: true,
    default: "",
  },
  {
    ...
    label: "Draft tokens",
    help: "Tokens the drafter proposes per step. Used when a draft model is selected.",
    type: "number",
    engines: ["lm"],
    advanced: true,
    min: 1,
  ...
  },
  {
    ...
    flag: "--chat-template",
    label: "Chat template",
    help: "Jinja chat template. Pull from Hugging Face if the checkpoint did not ship one (MiniMax / gpt-oss). mlx-lm.server only — mlx-vlm.server has no --chat-template.",
    type: "text",
    engines: ["lm"],
    group: "template",
    default: "",
  },
  {
    ...
    help: "JSON object passed to apply_chat_template. mlx-lm.server only.",
    type: "text",
    engines: ["lm"],
    advanced: true,
    default: "",
  },
  {
    ...
    help: "Force the tokenizer default template instead of a custom one. mlx-lm.server only.",
    type: "bool",
    engines: ["lm"],
    group: "template",
    default: false,
